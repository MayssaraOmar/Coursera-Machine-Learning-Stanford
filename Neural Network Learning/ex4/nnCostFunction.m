...
% Feedforward the neural network to return the cost in the variable J. 
% forward Prob
a1 = [ones(m,1) X];
...
% map the output vector (y) into a binary vector of 1's and 0's to be used with the neural networkcost function.
Y = zeros(size(a3));
for i = 1:m
...
% the partial derivatives of the cost function with respect to Theta1 and Theta2 are stored in Theta1_grad and Theta2_grad, respectively.
